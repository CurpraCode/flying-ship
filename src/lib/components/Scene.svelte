<script lang="ts">
  ...
  import { Color, Group, Mesh, PMREMGenerator, PlaneGeometry, Raycaster, Texture, Vector2, Vector3 } from 'three';
  import { onMount } from 'svelte';
  import Stars from './Star.svelte';
  ...
  let spaceShipRef: Group<Object3DEventMap> | undefined;
  ...
  let envMapRT: Texture | undefined;
